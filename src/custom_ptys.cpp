...
void loadIsaacPTYs() {
  ...
  e.song = "RADIO METROPOLITANA 79.7MHZ - A RADIO DA COMUNIDADE";
  ...
  e.song = "RADIO EDUCATIVA - IFCE FM - EDUCACAO E CULTURA NO AR";
  customPtys.push_back(e);
  ...
  e.song = "CEARA FM 87.1MHZ - O SOM DO CEARA";
  customPtys.push_back(e);
  ...
  e.song = "RADIO JERUSALEM FM - A VOZ DE DEUS NO AR";
  customPtys.push_back(e);
  ...
  e.song = "JANGADEIRO FM - A RADIO QUE TODO MUNDO AMA";
  customPtys.push_back(e);
  ...
  e.song = "89 FM 89.9 FM - A MAIS TOCADA DE FORTALEZA";
  customPtys.push_back(e);
  ...
  e.song = "FORTALEZA FM - A RADIO DE FORTALEZA";
  customPtys.push_back(e);
  ...
  e.song = "RADIO UIRAPURU - REDE ALELUIA - REDE ALELUIA - GLORIA A DEUS";
  customPtys.push_back(e);
  ...
  e.song = "SHALOM FM 91.7MHZ - COMUNIDADE SHALOM NO AR";
  customPtys.push_back(e);
  ...
  e.song = "RADIO EFRAIM - A RADIO GOSPEL DO CEARA";
  customPtys.push_back(e);
  ...
  e.song = "VERDINHA FM 92.5 - JORNALISMO QUE FALA A NOSSA LINGUA";
  customPtys.push_back(e);
  ...
  e.song = "JOVEM PAN NEWS FORTALEZA - A RADIO QUE TOCA NOTICIA";
  customPtys.push_back(e);
  ...
  e.song = "CANAA FM 93.5 - A TERRA PROMETIDA DO RADIO";
  customPtys.push_back(e);
  ...
  e.song = "FM 93 SEMPRE AO SEU LADO - SEMPRE AO SEU LADO";
  customPtys.push_back(e);
  ...
  e.song = "SOL FM 94.3 OFICIAL - NOSSO BRILHO E VOCE";
  customPtys.push_back(e);
  ...
  e.song = "JOVEM PAN FORTALEZA FM 94.7 - A MELHOR RADIO DO BRASIL";
  customPtys.push_back(e);
  ...
  e.song = "LOGOS FM - A PALAVRA DE DEUS NO AR";
  customPtys.push_back(e);
  ...
  e.song = "CBN O POVO - A RADIO QUE TOCA NOTICIA";
  customPtys.push_back(e);
  ...
  e.song = "DOMBOSCO FM 96,1 - A RADIO SALESIANA DO CEARA";
  customPtys.push_back(e);
  ...
  e.song = "ALECE FM 96.7MHZ - A RADIO DA ASSEMBLEIA LEGISLATIVA";
  customPtys.push_back(e);
  ...
  e.song = "RADIO MARIA BRASIL - AVE MARIA CHEIA DE GRACA";
  customPtys.push_back(e);
  ...
  e.song = "ANTENA 1 FM 97.7 - SOM INTERNACIONAL SINTONIA LOCAL";
  customPtys.push_back(e);
  ...
  e.song = "RADIO LIDER FM GOSPEL 98.3 - A LIDER DO GOSPEL DO CEARA";
  customPtys.push_back(e);
  ...
  e.song = "CIDADE FM 99.1 - A RADIO DA CIDADE DE FORTALEZA";
  customPtys.push_back(e);
  ...
  e.song = "REDE ALELUIA FM 99.9 - GLORIA A DEUS NAS ALTURAS";
  customPtys.push_back(e);
  ...
  e.song = "DEUS E AMOR FM 100.9 - DEUS E AMOR - A RADIO DA CURA";
  customPtys.push_back(e);
  ...
  e.song = "NOVA RADIO CRISTA - A NOVA VOZ DO EVANGELHO";
  customPtys.push_back(e);
  ...
  e.song = "BANDNEWS FM 101.7 - TODA HORA TODA NOTICIA";
  customPtys.push_back(e);
  ...
  e.song = "TEMPLO CENTRAL FM 102.3 - O TEMPLO DE DEUS NO AR";
  customPtys.push_back(e);
  ...
  e.song = "RADIO BEACH PARK FM 102.7 - A CADA MUSICA UMA NOVA DESCOBERTA";
  customPtys.push_back(e);
  ...
  e.song = "RADIO SENADO - O SOM DA DEMOCRACIA";
  customPtys.push_back(e);
  ...
  e.song = "REDE SHALOM DE RADIO - COMUNIDADE SHALOM - PAZ E BEM";
  customPtys.push_back(e);
  ...
  e.song = "TEMPO FM 103.9 A SUA MELHOR ESTACAO. - O TEMPO TODO COM VOCE";
  customPtys.push_back(e);
  ...
  e.song = "REDE METROPOLITANA FM 104.3 - YES!!!";
  customPtys.push_back(e);
  ...
  e.song = "AD CIDADE FM 105.1MHZ - ASSEMBLEIA DE DEUS NO AR";
  customPtys.push_back(e);
  ...
  e.song = "ATLANTICO SUL FM 105.7 - SUA VIDA NA MELHOR TRILHA";
  customPtys.push_back(e);
  ...
  e.song = "NOVABRASIL FM 106.5 - A MAIOR AUDIENCIA NO PUBLICO ADULTO";
  customPtys.push_back(e);
  ...
  e.song = "MIX FM 107.5 - OS MAIORES HITS DO MOMENTO";
  customPtys.push_back(e);
  ...
  e.song = "107.9MHZ UNIVERSITARIA FM 107.9MHZ - A RADIO DA UFC - CULTURA E SABER";
  customPtys.push_back(e);
...
String concatenateRTWithCustom(const String &incomingRT, uint32_t freq_khz) {
  ...
  String result = incomingRT;
  if (customPS.length() > 0) result += " | " + customPS;
  if (customRT.length() > 0) result += " | " + customRT;

...
void loadIsaacPTYs() {
  ...
  e.freq_khz = 99100;  e.pty = "Pop Music"; e.ps = "CIDADE FM 99.1"; customPtys.push_back(e);
  e.freq_khz = 99900;  e.pty = "Religion";  e.ps = "REDE ALELUIA FM 99.9"; customPtys.push_back(e);
  e.freq_khz = 100900; e.pty = "Religion";  e.ps = "DEUS E AMOR FM 100.9"; customPtys.push_back(e);
  e.freq_khz = 101300; e.pty = "Religion";  e.ps = "NOVA RADIO CRISTA"; customPtys.push_back(e);
  e.freq_khz = 101700; e.pty = "Pop Music"; e.ps = "BANDNEWS FM 101.7"; customPtys.push_back(e);
  e.freq_khz = 102300; e.pty = "Religion";  e.ps = "TEMPLO CENTRAL FM 102.3"; customPtys.push_back(e);
  e.freq_khz = 102700; e.pty = "Pop Music"; e.ps = "RADIO BEACH PARK FM 102.7"; customPtys.push_back(e);
  e.freq_khz = 103300; e.pty = "Pop Music"; e.ps = "RADIO SENADO"; customPtys.push_back(e);
